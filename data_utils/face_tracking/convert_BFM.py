...
original_BFM = loadmat("/content/SyncTalk/data_utils/face_tracking/3DMM/01_MorphableModel.mat")
sub_inds = np.load("/content/SyncTalk/data_utils/face_tracking/3DMM/topology_info.npy", allow_pickle=True).item()["sub_inds"]
...
exp_info = np.load("/content/SyncTalk/data_utils/face_tracking/3DMM/exp_info.npy", allow_pickle=True).item()
np.save(
    "/content/SyncTalk/data_utils/face_tracking/3DMM/3DMM_info.npy",
    {
        "mu_shape": mu_shape,
        "b_shape": b_shape,
